...
## [1.1.0.5] - DEC-29-2024 10:00

### 固件勘误

+ 彻底重构温控系统解决温控降档亮度不稳定反复高频波动的问题
+ 解决因为低电量限流导致爆闪和SOS模式无法正常工作的问题
+ 为按键处理增加动态的长按延迟判定解决战术模式下按住开机所需时间过久影响体验的问题
...
+ 新增战术模式双击切换一键极亮和爆闪的功能以及进入战术模式后的侧按指示
+ 将爆闪的电流修改为22A接近全功率爆闪
+ 将电池低电量保护的逻辑处理全部移动到新的[LowVoltageProt.c](/Firmware/Logic/LowVoltageProt.c)文件内和电池电量显示分开
+ 新增用于实现锁定/战术模式功能切换的[SpecialMode.c](/Firmware/Logic/SpecialMode.c)文件
